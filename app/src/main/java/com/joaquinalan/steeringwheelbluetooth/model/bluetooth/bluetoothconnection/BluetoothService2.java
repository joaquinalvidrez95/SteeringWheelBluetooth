...
public class BluetoothService2 implements BluetoothConnection {
    ...
    public BluetoothService2(BluetoothServiceListener bluetoothServiceListener, Handler handler) {
